...
#define CNO_TEST_ENGINE_UTEST 3
#define CNO_TEST_ENGINE_MINCTEST 4
#define CNO_TEST_ENGINE_MUNIT 5
#if !defined(CNO_TEST_ENGINE)
#if CNO_HAVE_MUNIT
#define CNO_TEST_ENGINE CNO_TEST_ENGINE_MUNIT
#else
...
#define CNO_SETTINGS_OPTIONS_ENGINE_COMMANDER 4
