...
//cno_time
#define C\TIME_ENGINE_NONE 0
#define C\TIME_ENGINE_OTHER 1
#define C\TIME_ENGINE_TIME 2
#define C\TIME_ENGINE_SDL2 3
#if !defined(C\TIME_ENGINE)
#if C\H\SDL2
#define C\TIME_ENGINE C\TIME_ENGINE_SDL2
#elif C\H\TIME
#define C\TIME_ENGINE C\TIME_ENGINE_TIME
#else
#define C\TIME_ENGINE C\TIME_ENGINE_NONE
#endif //C\H\SDL2
#endif //!defined(C\TIME_ENGINE)

//cno_assertion
#define C\ASSERTION_ENGINE_NONE 0
#define C\ASSERTION_ENGINE_OTHER 1
#define C\ASSERTION_ENGINE_ASSERT 2
#define C\ASSERTION_ENGINE_SDL2 3
#if !defined(C\ASSERTION_ENGINE)
#if C\H\SDL2
#define C\ASSERTION_ENGINE C\ASSERTION_ENGINE_SDL2
#elif C\H\ASSERT
#define C\ASSERTION_ENGINE C\ASSERTION_ENGINE_ASSERT
#else
#define C\ASSERION_ENGINE C\ASSERTION_ENGINE_NONE
#endif //C\H\SDL2
#endif //!defined(C\ASSERTION_ENGINE)
...
//cno_test
#define C\TEST_ENGINE_NONE 0
#define C\TEST_ENGINE_OTHER 1
#define C\TEST_ENGINE_INTERNAL 2
#define C\TEST_ENGINE_UTEST 3
#define C\TEST_ENGINE_MINCTEST 4
#define C\TEST_ENGINE_MUNIT 5
#if !defined(C\TEST_ENGINE)
#if C\H\MUNIT
#define C\TEST_ENGINE C\TEST_ENGINE_MUNIT
#else
#define C\TEST_ENGINE C\TEST_ENGINE_NONE
#endif //C\H\MUNIT
#endif //!defined(C\TEST_ENGINE)
...
#define C\SETTINGS_OPTIONS_ENGINE_COMMANDER 4
#if !defined(CNO_SETTINGS_OPTIONS_ENGINE)
#if CNO_HAVE_ARGP
#define CNO_SETTINGS_OPTIONS_ENGINE CNO_SETTINGS_OPTIONS_ENGINE_ARGP
#else
...
#if CNO_HAVE_PARSON
#define CNO_SETTINGS_CONFIG_ENGINE CNO_SETTINGS_CONFIG_ENGINE_PARSON
#else
...
#if CNO_HAVE_SDL2
#define CNO_LOG_ENGINE CNO_LOG_ENGINE_SDL2
#else
#define CNO_LOG_ENGINE CNO_LOG_ENGINE_NONE
#endif //CNO_HAVE_CLOGGED
