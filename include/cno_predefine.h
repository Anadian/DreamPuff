//cno_predefine.h
#ifndef CNO_PREDEFINE_H
#define CNO_PREDEFINE_H
...
#define CNO_ARCHITECTURE_ARM64 1
#define CNO_ARCHITECTURE "ARM64"
...
#define CNO_ARCHITECTURE_I386 1
...
#define CNO_ARCHITECTURE_MIPS 1
...
#define CNO_ARCHITECTURE_POWERPC 1
...
#define CNO_ARCHITECTURE_SPARC 1
#define CNO_ARCHITECTURE "SPARC"
...
#define CNO_ARCHITECTURE_BLACKFIN 1
#define CNO_ARCHITECTURE "Blackfin"
...
#define CNO_ARCHITECTURE_CONVEX 1
#define CNO_ARCHITECTURE "Convex"
...
#define CNO_ARCHITECTURE_EPIPHANY 1
#define CNO_ARCHITECTURE "Epiphany"
...
#define CNO_ARCHITECTURE_HPPA 1
#define CNO_ARCHITECTURE "HP/PA RISC"
...
#define CNO_ARCHITECTURE_IA64 1
#define CNO_ARCHITECTURE "IA64"
...
#define CNO_ARCHITECTURE_M68K 1
#define CNO_ARCHITECTURE "M68K"
...
#if defined(pyr)
#define CNO_ARCHITECTURE_PYRAMID 1
#define CNO_ARCHITECTURE "Pyramid 9810"
#endif //defined(pyr)
...
#define CNO_ARCHITECTURE_RS6000 1
#define CNO_ARCHITECTURE "RS/6000"
...
#define CNO_ARCHITECTURE_SUPERH 1
#define CNO_ARCHITECTURE "SuperH"
...
#define CNO_ARCHITECTURE_SYSTEMZ 1
#define CNO_ARCHITECTURE "SystemZ"
...
#define CNO_ARCHITECTURE_TMS320 1
#define CNO_ARCHITECTURE "TMS320"
#endif //defined(_TMS320C2XX) || defined(__TMS320C2000__) || defined(_TMS320C5X) || defined(__TMS320C55X__) || defined(_TMS320C6X) || defined(__TMS320C6X__) || defined(_TMS320C28X) || defined(_TMS320C5XX) || defined(__TMS320C55X__) || defined(_TMS320C6200) || defined(_TMS320C6400) || defined(_TMS320C6400_PLUS) || defined(_TMS320C6600) || defined(_TMS320C6700) || defined(_TMS320C6700_PLUS) || defined(_TMS320C6740)
#if defined(__TMS470__)
#define CNO_ARCHITECTURE_TMS470 1
#define CNO_ARCHITECTURE "TMS470"
#endif //defined(__TMS470__)
#endif //Vintage or obscure architectures.
...
#elif defined(__MINGW32__) || defined(__MINGW32_MAJOR_VERSION) || defined(__MINGW32_MINOR_VERSION) || defined(__MINGW64__) || defined(__MINGW64_VERSION_MAJOR) || defined(__MINGW64_VERSION_MINOR)
#define CNO_COMPILER_MINGW 1
#define CNO_COMPILER "MinGW"
...
#define CNO_COMPILER_MICROSOFT_VISUAL 1
#define CNO_COMPILER "Microsoft Visual C++"
...
#define CNO_COMPILER_LLVM 1
#define CNO_COMPILER "llvm"
//#endif //defined(__llvm__)
#elif defined(__TINYC__)
#define CNO_COMPILER_TINYC 1
#define CNO_COMPILER "Tiny C"
//#endif //defined(__TINYC__)
#elif defined(__MWERKS__) || defined(__CWCC__)
#define CNO_COMPILER_METROWERKS_CODEWARRIOR 1
#define CNO_COMPILER "Metrowerks CodeWarrior"
//#endif //defined(__MWERKS__) || defined(__CWCC__)
#elif defined(__BORLANDC__) || defined(__CODEGEARC__)
#define CNO_COMPILER_BORLAND 1
#define CNO_COMPILER "Borland C++"
#endif //defined(__BORLANDC__) || defined(__CODEGEARC__)

#if 0 //Vintage and esoteric C compilers
#if defined(_ACC_)
#define CNO_COMPILER_ACC 1
#define CNO_COMPILER "ACC"
#endif //defined(_ACC_)
#if defined(__CMB__)
# defined(__VERSION__) || defined(__REVISION__) || defined(__BUILD__)
#define CNO_COMPILER_ALTIUM_MICROBLAZE 1
#define CNO_COMPILER "Altium MicroBlaze C"
#endif //defined(__CMB__) || defined(__VERSION__) || defined(__REVISION__) || defined(__BUILD__)
#if defined(__CHC__)
# defined(__VERSION__) || defined(__REVISION__) || defined(__BUILD__)
#define CNO_COMPILER_ALTIUM_C_TO_HARDWARE 1
#define CNO_COMPILER "Altium C-to-Hardware"
#endif //defined(__CHC__) || defined(__VERSION__) || defined(__REVISION__) || defined(__BUILD__)
#if defined(__ACK__)
#define CNO_COMPILER_AMSTERDAM_COMPILER_KIT 1
#define CNO_COMPILER "Amsterdam Compiler Kit"
#endif //defined(__ACK__)
#if defined(__CC_ARM) || defined(__ARMCC_VERSION)
#define CNO_COMPILER_ARM_COMPILER 1
#define CNO_COMPILER "ARM Compiler"
#endif //defined(__CC_ARM) || defined(__ARMCC_VERSION)
#if defined(AZTEC_C) || defined(__AZTEC_C__)
# defined(__VERSION)
#define CNO_COMPILER_AZTEC 1
#define CNO_COMPILER "Aztec C"
#endif //defined(AZTEC_C) || defined(__AZTEC_C__) || defined(__VERSION)
#if defined(__CC65__)
#define CNO_COMPILER_CC65 1
#define CNO_COMPILER "CC65"
#endif //defined(__CC65__)
#if defined(__COMO__) || defined(__COMO_VERSION__)
#define CNO_COMPILER_COMEAU 1
#define CNO_COMPILER "Comeau C++"
...
#define CNO_COMPILER_EKOPATH 1
#define CNO_COMPILER "EKOPath"
#endif //defined(__PATHCC__) || defined(__PATHCC_MINOR__) || defined(__PATHCC_PATCHLEVEL__)
#if defined(__FCC_VERSION)
#define CNO_COMPILER_FUJITSU 1
#define CNO_COMPILER "Fujitsu C++"
...
#define CNO_COMPILER_INTEL 1
#define CNO_COMPILER "Intel C/C++"
...
#define CNO_COMPILER_KAI 1
#define CNO_COMPILER "KAI C++"
#endif //defined(__KCC) || defined(__KCC_VERSION)
#if defined(__CA__) || defined(__KEIL__)
#define CNO_COMPILER_KEIL_CARM 1
#define CNO_COMPILER "KEIL CARM"
#endif //defined(__CA__) || defined(__KEIL__)
#if defined(__C166__)
#define CNO_COMPILER_KEIL_C166 1
#define CNO_COMPILER "KEIL C166"
#endif //defined(__C166__)
#if defined(__C51__) || defined(__CX51__)
#define CNO_COMPILER_KEIL_C51 1
#define CNO_COMPILER "KEIL C51"
#endif //defined(__C51__) || defined(__CX51__)
#if defined(__LCC__)
#define CNO_COMPILER_LLC 1
#define CNO_COMPILER "LLC"
#endif //defined(__LCC__)
#if defined(__HIGHC__)
#define CNO_COMPILER_METAWARE_HIGH 1
#define CNO_COMPILER "MetaWare High C/C++"
#endif //defined(__HIGHC__)
#if defined(_MRI)
#define CNO_COMPILER_MICROTEC 1
#define CNO_COMPILER "Microtec C/C++"
#endif //defined(_MRI)
#if defined(__NDPC__) || defined(__NDPX__)
#define CNO_COMPILER_MICROWAY_NDP 1
#define CNO_COMPILER "Microway NDP C"
...
#define CNO_COMPILER_RENESAS 1
#define CNO_COMPILER "Renesas"
...
#define CNO_COMPILER_SAS 1
#define CNO_COMPILER "SAS/C"
#endif //defined(SASC) || defined(__SASC) || defined(__SASC__) || defined(__VERSION__) || defined(__REVISION__)
#if defined(_SCO_DS)
#define CNO_COMPILER_SCO 1
#define CNO_COMPILER "SCO OpenServer"
#endif //defined(_SCO_DS)
#if defined(SDCC)
#define CNO_COMPILER_SDCC 1
#define CNO_COMPILER "Small Device C Compiler"
#endif //defined(SDCC)
#if defined(__SNC__)
#define CNO_COMPILER_SN 1
#define CNO_COMPILER "SN Compiler"
#endif //defined(__SNC__)
#if defined(__VOSC__)
#define CNO_COMPILER_STRATOS 1
#define CNO_COMPILER "Stratos VOS"
#endif //defined(__VOSC__)
#if defined(__SC__)
#define CNO_COMPILER_SYMANTEC 1
#define CNO_COMPILER "Symantec C"
#endif //defined(__SC__)
#if defined(__TenDRA__)
#define CNO_COMPILER_TENDRA 1
#define CNO_COMPILER "TenDRA C/C++"
#endif //defined(__TenDRA__)
#if defined(__TI_COMPILER_VERSION__) || defined(_TMS320C6X)
#define CNO_COMPILER_TEXAS_INSTRUMENTS 1
#define CNO_COMPILER "Texas Instruments C/C++"
#endif //defined(__TI_COMPILER_VERSION__) || defined(_TMS320C6X)
#if defined(THINKC3) || defined(THINKC4)
#define CNO_COMPILER_THINKC 1
#define CNO_COMPILER "THINK C"
#endif //defined(THINKC3) || defined(THINKC4)
#if defined(__TURBOC__)
#define CNO_COMPILER_TURBOS 1
#define CNO_COMPILER "Turbo C/C++"
#endif //defined(__TURBOC__)
#if defined(_UCC) || defined(_MAJOR_REV) || defined(_MINOR_REV)
#define CNO_COMPILER_ULTIMATE 1
#define CNO_COMPILER "Ultimate C/C++"
#endif //defined(_UCC) || defined(_MAJOR_REV) || defined(_MINOR_REV)
#if defined(__USLC__) || defined(__SCO_VERSION__) 
#define CNO_COMPILER_USL 1
#define CNO_COMPILER "USL C"
#endif //defined(__USLC__) || defined(__SCO_VERSION__) 
#if defined(__VBCC__)
#define CNO_COMPILER_VBCC 1
#define CNO_COMPILER "VBCC"
#endif //defined(__VBCC__)
#if defined(__WATCOMC__)
#define CNO_COMPILER_WATCOM 1
#define CNO_COMPILER "Watcom C++"
#endif //defined(__WATCOMC__)
#if defined(__ZTC__)
#define CNO_COMPILER_ZORTECH 1
#define CNO_COMPILER "Zortech C++"
#endif //defined(__ZTC__)
#endif //Vintage and esoteric C Compilers

//SYSTEM
#if defined(__CYGWIN__)
#define CNO_SYSTEM_CYGWIN 1
#define CNO_SYSTEM "Cygwin"
...
#define CNO_SYSTEM_WINDOWSCE 1
#define CNO_SYSTEM "Windows CE"
...
#define CNO_SYSTEM_NETBSD 1
#define CNO_SYSTEM "NetBSD"
...
#define CNO_SYSTEM_GNU_HURD 1
#define CNO_SYSTEM "GNU/Hurd"
//#endif //defined(__gnu_hurd__)
#elif defined(sun) || defined(__sun) || defined(__SunOS_5_7) || defined(__SunOS_5_8)
#define CNO_SYSTEM_SOLARIS 1
#define CNO_SYSTEM "Sun Solaris"
//#endif //defined(sun) || defined(__sun) || defined(__SunOS_5_7) || defined(__SunOS_5_8)
#elif defined(__FreeBSD_kernel__) && defined(__GLIBC__)
#define CNO_SYSTEM_FREEBSD_KERNEL 1
#define CNO_SYSTEM "GNU/FreeBSD Kernel"
...
#define CNO_SYSTEM_FREEBSD 1
#define CNO_SYSTEM "FreeBSD"
...
#define CNO_SYSTEM_GNU 1
#define CNO_SYSTEM "GNU"
//#endif //defined(__GNU__) || defined(__GLIBC__)
#elif defined(__linux__) || defined(linux) || defined(__linux)
#define CNO_SYSTEM_LINUX 1
#define CNO_SYSTEM "Linux"
//#endif //defined(__linux__) || defined(linux) || defined(__linux)
#elif defined(__unix__) || defined(__unix)
#define CNO_SYSTEM_UNIX 1
#define CNO_SYSTEM "Unix"
#endif //defined(__unix__) || defined(__unix)

#if 0 //Obscure systems
#if defined(_AIX) || defined(__TOS_AIX__) || defined(_AIX3) || defined(_AIX32) || defined(_AIX41) || defined(_AIX43)
#define CNO_SYSTEM_AIX 1
#define CNO_SYSTEM "AIX"
#endif //defined(_AIX) || defined(__TOS_AIX__) || defined(_AIX3) || defined(_AIX32) || defined(_AIX41) || defined(_AIX43)
#if defined(UTS)
#define CNO_SYSTEM_AMDAHL_UTS 1
#define CNO_SYSTEM "Amdahl UTS"
#endif //defined(UTS)
#if defined(AMIGA) || defined(__amigaos__)
#define CNO_SYSTEM_AMIGA 1
#define CNO_SYSTEM "AmigaOS"
#endif //defined(AMIGA) || defined(__amigaos__)
#if defined(aegis)
#define CNO_SYSTEM_AEGIS 1
#define CNO_SYSTEM "Apollo AEGIS"
#endif //defined(aegis)
#if defined(apollo)
#define CNO_SYSTEM_APOLLO 1
#define CNO_SYSTEM "Apollo Domain/OS"
#endif //defined(apollo)
#if defined(__BEOS__)
#define CNO_SYSTEM_BEOS 1
#define CNO_SYSTEM "BeOS"
#endif //defined(__BEOS__)
#if defined(__bg__) || defined(__bgq__) || defined(__THW_BLUEGENE__) || defined(__TOS_BGQ__)
#define CNO_SYSTEM_BLUE_GENE 1
#define CNO_SYSTEM "Blue Gene"
#endif //defined(__bg__) || defined(__bgq__) || defined(__THW_BLUEGENE__) || defined(__TOS_BGQ__)
#if defined(__convex__)
#define CNO_SYSTEM_CONVEX 1
#define CNO_SYSTEM "ConvexOS"
#endif //defined(__convex__)
#if defined(DGUX) || defined(__DGUX__) || defined(__dgux__)
#define CNO_SYSTEM_DGUX 1
#define CNO_SYSTEM "DG/UX"
#endif //defined(DGUX) || defined(__DGUX__) || defined(__dgux__)
#if defined(__DragonFly__)
#define CNO_SYSTEM_DRAGONFLY 1
#define CNO_SYSTEM "DragonFly"
#endif //defined(__DragonFly__)
#if defined(_SEQUENT_) || defined(sequent)
#define CNO_SYSTEM_DYNIX 1
#define CNO_SYSTEM "DYNIX/ptx (SEQUENT)"
#endif //defined(_SEQUENT_) || defined(sequent)
#if defined(__ECOS)
#define CNO_SYSTEM_ECOS 1
#define CNO_SYSTEM "eCos"
#endif //defined(__ECOS)
#if defined(__EMX__)
#define CNO_SYSTEM_EMX 1
#define CNO_SYSTEM "EMX Environment"
#endif //defined(__EMX__)
#if defined(__hiuxmpp)
#define CNO_SYSTEM_HIUXMPP 1
#define CNO_SYSTEM "HI-UX MPP"
#endif //defined(__hiuxmpp)
#if defined(_hpux) || defined(hpux) || defined(__hpux)
#define CNO_SYSTEM_HPUX 1
#define CNO_SYSTEM "HP-UX"
#endif //defined(_hpux) || defined(hpux) || defined(__hpux)
#if defined(__OS400__)
#define CNO_SYSTEM_IBM_OS_400 1
#define CNO_SYSTEM "IBM OS 400"
#endif //defined(__OS400__)
#if defined(__INTEGRITY)
#define CNO_SYSTEM_INTEGRITY 1
#define CNO_SYSTEM "INTEGRITY"
#endif //defined(__INTEGRITY)
#if defined(__INTERIX)
#define CNO_SYSTEM_INTERIX 1
#define CNO_SYSTEM "Interix Environment"
#endif //defined(__INTERIX)
#if defined(sgi) || defined(__sgi)
#define CNO_SYSTEM_IRIX 1
#define CNO_SYSTEM "IRIX (sgi)"
#endif //defined(sgi) || defined(__sgi)
#if defined(__OS9000) || defined(_OSK)
#define CNO_SYSTEM_OS9000 1
#define CNO_SYSTEM "Microware OS9"
#endif //defined(__OS9000) || defined(_OSK)
#if defined(__MORPHOS__)
#define CNO_SYSTEM_MORPHOS 1
#define CNO_SYSTEM "Morph OS"
#endif //defined(__MORPHOS__)
#if defined(mpeix) || defined(__mpexl)
#define CNO_SYSTEM_MPEIX 1
#define CNO_SYSTEM "MPE/ix"
#endif //defined(mpeix) || defined(__mpexl)
#if defined(__TANDEM)
#define CNO_SYSTEM_TANDEM 1
#define CNO_SYSTEM "NonStop (TANDEM)"
#endif //defined(__TANDEM)
#if defined(__nucleus__)
#define CNO_SYSTEM_NUCLEUS 1
#define CNO_SYSTEM "Nucleus RTOS"
#endif //defined(__nucleus__)
#if defined(OS2) || defined(_OS2) || defined(__OS2__) || defined(__TOS_OS2__)
#define CNO_SYSTEM_OS2 1
#define CNO_SYSTEM "OS/2"
#endif //defined(OS2) || defined(_OS2) || defined(__OS2__) || defined(__TOS_OS2__)
#if defined(__palmos__)
#define CNO_SYSTEM_PALMOS 1
#define CNO_SYSTEM "PalmOS"
#endif //defined(__palmos__)
#if defined(EPLAN9)
#define CNO_SYSTEM_PLAN9 1
#define CNO_SYSTEM "Plan9 (EPLAN9)"
#endif //defined(EPLAN9)
#if defined(pyr)
#define CNO_SYSTEM_PYRAMID 1
#define CNO_SYSTEM "Pyramid DC/OSx"
#endif //defined(pyr)
#if defined(sinux)
#define CNO_SYSTEM_RELIANT 1
#define CNO_SYSTEM "Reliant Unix (sinux)"
#endif //defined(sinux)
#if defined(M_I386) || defined(M_XENIX) || defined(_SCO_DS)
#define CNO_SYSTEM_M_I386 1
#define CNO_SYSTEM "SCO OpenServer (M_I386)"
#endif //defined(M_I386) || defined(M_XENIX) || defined(_SCO_DS)
#if defined(__VOS__)
#define CNO_SYSTEM_STRATUS 1
#define CNO_SYSTEM "Stratus VOS"
#endif //defined(__VOS__)
#if defined(__sysv__) || defined(__SVR4) || defined(__svr4__) || defined(_SYSTYPE_SVR4)
#define CNO_SYSTEM_SVR4 1
#define CNO_SYSTEM "SVR4 Environment (sysv)"
#endif //defined(__sysv__) || defined(__SVR4) || defined(__svr4__) || defined(_SYSTYPE_SVR4)
#if defined(__SYLLABLE__)
#define CNO_SYSTEM_SYLLABLE 1
#define CNO_SYSTEM "Syllable"
#endif //defined(__SYLLABLE__)
#if defined(__SYMBIAN32__)
#define CNO_SYSTEM_SYMBIAN 1
#define CNO_SYSTEM "Symbian 32"
#endif //defined(__SYMBIAN32__)
#if defined(__osf__) || defined(__osf)
#define CNO_SYSTEM_TRU64 1
#define CNO_SYSTEM "Tru64 OSF/1"
#endif //defined(__osf__) || defined(__osf)
#if defined(ultrix) || defined(__ultrix) || defined(__ultrix__) || (defined(unix) && defined(vax))
#define CNO_SYSTEM_ULTRIX 1
#define CNO_SYSTEM "Ultrix"
#endif //defined(ultrix) || defined(__ultrix) || defined(__ultrix__) || (defined(unix) && defined(vax))
#if defined(_UNICOS)
#define CNO_SYSTEM_UNICOS 1
#define CNO_SYSTEM "UNICOS"
#endif //defined(_UNICOS)
#if defined(_CRAY) || defined(__crayx1)
#define CNO_SYSTEM_CRAY 1
#define CNO_SYSTEM "UNICOS/mp (CRAY)"
#endif //defined(_CRAY) || defined(__crayx1)
#if defined(sco) || defined(_UNIXWARE7)
#define CNO_SYSTEM_UNIXWARE 1
#define CNO_SYSTEM "UnixWare (SCO)"
#endif //defined(sco) || defined(_UNIXWARE7)
#if defined(_UWIN)
#define CNO_SYSTEM_UWIN 1
#define CNO_SYSTEM "U/WIN Environment"
#endif //defined(_UWIN)
#if defined(VMS) || defined(__VMS) ||defined(__VMS_VER)
#define CNO_SYSTEM_VMS 1
#define CNO_SYSTEM "VMS"
...
#define CNO_SYSTEM_VXWORKS 1
#define CNO_SYSTEM "VxWorks"
