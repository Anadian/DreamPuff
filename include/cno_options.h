...
static CNO_Option_type CNO_Options[] = {
		...
		{"error",'e', C\Options_Arguments_Required,"STREAM","Redirect stderr to the given stream; exempli gratia, STDOUT or a the name of a file.",0,NULL},
		...
		{"list",'l',CNO_Option_Arguments_Optional,"\0","List?",0,NULL},
