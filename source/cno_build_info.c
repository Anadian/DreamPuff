...
#if CNO_HAVE_STDIO
	cno_sprintf(CNO_Build_String, "%s v%d.%d (%s %s, %s) %s %s %d", CNO_BUILD_NAME, CNO_BUILD_VERSION_MAJOR, CNO_BUILD_VERSION_MINOR, CNO_BUILD_DATE, CNO_BUILD_TIME, CNO_COMPILER_NAME, CNO_ARCHITECTURE_NAME, CNO_OS_NAME, CNO_DEVICE_TYPE);
#if CNO_ALLOW_PRINTF
	cno_printf("%s\n",CNO_Build_String);
